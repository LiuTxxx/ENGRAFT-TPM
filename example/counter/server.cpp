...
int main(int argc, char* argv[]) {
    ...
    options.mutable_ssl_options()->default_cert.certificate = "example/counter/cert.pem";
    options.mutable_ssl_options()->default_cert.private_key = "example/counter/key.pem";
