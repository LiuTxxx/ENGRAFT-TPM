...
int main(int argc, const char* argv[]) {
    ...
    //- 2. Set up tpm session environment
    int tpm_init_rc = initialize_tpm2();
    // int tpm_init_rc = initialize_tpm2_mssim();
    if (tpm_init_rc != 0) {
        printf("INIT TPM ERROR\n");
    }
#endif
    ...
    // Test tpm counter usage: enter the enclave for testing and return when done
    // enclave_test(enclave);
    // return 0;
