...
"MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA/HkhgAABcyuvaP45KRxb\n"
"RXeiL5XvPCIBwmX0o9YVg5Xc0AsqkDIQwGWDsS/jfkoWKOx58dXqHZfEbZ4pxcn2\n"
"yLeD19m+ITIsTgrnk6K3wvCylPy6P9bijz7e8b4D5Ped4svzUwRqdFQRGendwx0K\n"
"gdTADMRMTeiJanuUOAG9GiL+EL9Qw9jVzboyZYB12Cu1flaWhWim+XkMejrQ4pP1\n"
"jx/a86nc2J7zy38WzSteyLXdkWUdJipiwI6rNV0VMzOGW/QTlLJ25KNHJ1uqpLXs\n"
"OygFowYIN+11+ZJF5fzfJWx6lS8Y9prsH+iGDUck/pzNH2q5m5/FzfFVHEZiYZl2\n"
"DQIDAQAB\n"
"-----END PUBLIC KEY-----";
...
bool TPMCounter::detect_rollback(CounterID counter_index, CounterVal counter_val) {
    // Read the counter value from TPM
    CounterVal val = read_counter(counter_index);
    if (val == counter_val + 1) {
        LOG(ERROR) << "Func: " << __FUNCTION__ << " NO Rollback detected.";
    }
    return !(val == counter_val + 1);
}
